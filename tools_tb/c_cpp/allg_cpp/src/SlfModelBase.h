...
namespace slf
{
  ...
  public:
    ...
    virtual okay_t  Jacobian(const double &tact, const CVectorD &x, CMatrixD &dxpdx, size_t lddxpdx){ mMessage.SetErr(FUNCTION_NOT_DEFINED, "Jacobi() not defined"); return NOT_OK; } /* Prototype Jacobi */
