...
//==========================================================================
//==========================================================================
status_t CDsParData::setSingleData(slf::CStr  *pinstanz     // Instanzname
                                   ,slf::CStrV *pgroup       // Gruppenhierachie
                                   ,slf::CStr  *pvarname     // Variablenname
                                   ,slf::CStr  *punit        // Einheit
                                   ,double   yfactor
                                   ,double   yoffset
                                   ,slf::CStr  *pcomment     // Kommentar
...
status_t CDsParData::setStringData(slf::CStr  *pinstanz     // Instanzname
                                  ,slf::CStrV *pgroup       // Gruppenhierachie
                                  ,slf::CStr  *pvarname     // Variablenname
                                  ,slf::CStr  *punit        // Einheit
                                  ,double   yfactor
...
status_t CDsParData::setStringMData(slf::CStr  *pinstanz     // Instanzname
                                  ,slf::CStrV *pgroup       // Gruppenhierachie
                                  ,slf::CStr  *pvarname     // Variablenname
                                  ,slf::CStr  *punit        // Einheit
                                  ,double   yfactor
...
status_t CDsParData::setVectorData(slf::CStr  *pinstanz     // Instanzname
                                  ,slf::CStrV *pgroup       // Gruppenhierachie
                                  ,slf::CStr  *pvarname     // Variablenname
                                  ,slf::CStr  *punit        // Einheit
                                  ,double   yfactor
...
status_t CDsParData::setMatrixData(slf::CStr  *pinstanz     // Instanzname
                                  ,slf::CStrV *pgroup       // Gruppenhierachie
                                  ,slf::CStr  *pvarname     // Variablenname
                                  ,slf::CStr  *punit        // Einheit
                                  ,double   yfactor
...
status_t CDsParData::set1DTableData(
                            slf::CStr  *pinstanz     // Instanzname
                           ,slf::CStrV *pgroup       // Gruppenhierachie
                           ,slf::CStr  *ptabname     // Tabellenname
                           ,slf::CStr  *pcomment     // Kommentar
                           ,slf::CStr  *pxname       // Variablenname x
                           ,slf::CStr  *pxunit       // Einheit x
                           ,double   xfactor
                           ,double   xoffset
                           ,slf::CStr  *pxcomment    // Kommentar x
                           ,uint32_t   nxvec
                           ,double   *pxvec        // Vektor x
                           ,slf::CStr  *pyname       // Variablenname x
                           ,slf::CStr  *pyunit       // Einheit x
                           ,double   yfactor
                           ,double   yoffset
                           ,slf::CStr  *pycomment    // Kommentar x
                           ,uint32_t   nyvec
                           ,double   *pyvec        // Vektor x
                           ,uint8_t    lin_flag /*=1*/ // Linear / Step
                           ) {

   slf::CStr  tabname;     // Tabellenname
   slf::CStr  comment;     // Kommentar
   slf::CStr  xname;       // Variablenname x
   slf::CStr  xunit;       // Einheit x
   slf::CStr  xcomment;    // Kommentar x
   slf::CStr  yname;       // Variablenname x
   slf::CStr  yunit;       // Einheit x
   slf::CStr  ycomment;    // Kommentar x
...
status_t CDsParData::set2DTableData(
                           ...
                           ,uint32_t   nxvec
                           ,double   *pxvec        // Vektor x
                           ,slf::CStr  *pyname       // Variablenname y
                           ,slf::CStr  *pyunit       // Einheit y
                           ,double   yfactor
                           ,double   yoffset
                           ,slf::CStr  *pycomment    // Kommentar y
                           ,uint32_t   nyvec
                           ,double   *pyvec        // Vektor y
                           ,slf::CStr  *pzname       // Variablenname z
                           ,slf::CStr  *pzunit       // Einheit z
                           ,double   zfactor
                           ,double   zoffset
                           ,slf::CStr  *pzcomment    // Kommentar z
   ...
   slf::CStr  xunit;       // Einheit x
   slf::CStr  xcomment;    // Kommentar x
   slf::CStr  yname;       // Variablenname y
   slf::CStr  yunit;       // Einheit y
   slf::CStr  ycomment;    // Kommentar y
   slf::CStr  zname;       // Variablenname z
   slf::CStr  zunit;       // Einheit z
   slf::CStr  zcomment;    // Kommentar z
...
status_t CDsParData::setData(slf::CStr     *pi       // Instanzname
                            ,slf::CStrV    *pg       // Gruppenhierachie
                            ,slf::CStr     *pvn      // Variablenname
                            ,slf::CStr     *pu       // Einheit
                            ,slf::CStr     *pcom     // Kommentar
...
//==========================================================================
//==========================================================================
SDsParDataGroup *CDsParData::findGroup(slf::CStr  &instanz     // Instanzname
                                  ,slf::CStrV &vgroup       // Gruppenhierachie
                                  ) {
    ...
    if( vgroup.getNrows() == 0 ) { // keine Gruppen angegeben
        ...
        for(i=0;i<vgroup.getNrows();i++) {
            ...
            slf::CStr gname = vgroup.get_str(i);
...
SDsParDataGroup *CDsParData::findorbuildGroup(slf::CStr  &instanz     // Instanzname
                                           ,slf::CStrV &vgroup       // Gruppenhierachie
                                           ) {
...
SDsParDataVariable *CDsParData::findVariable(SDsParDataGroup  *pdg  // Pointer auf Gruppe
                                            ,slf::CStr &varname       // Variablenname
                                            ) {
...
//=============================
bool   CDsParData::existGroup(slf::CStr &instanz,slf::CStrV &vgroup) {
...
// Besteht die Gruppenhierachie
//=============================
bool   CDsParData::existVar(slf::CStr &instanz,slf::CStrV &vgroup,slf::CStr &varname) {
...
//=============================
SDsParDataVariable *CDsParData::getVar(slf::CStr &instanz
                                  ,slf::CStrV &vgroup
                                  ,slf::CStr &varname) {
...
// iv-te Variable
//=======================================================================
slf::CStr *CDsParData::getVStringVar(uint32_t *group_list
                                  ,uint32_t nh
                                  ,uint32_t iv
                                  ,uint32_t irow
                                  ,uint32_t icol) {
...
uint32_t  *CDsParData::getVUint32Var(uint32_t *group_list
    ...
    if( pdvar ) {
        ...
        if( pdvar->NRow >0 && pdvar->NCol > 0 ) {
            ...
            puint32 = (uint32_t *)pdvar->pVal;

            if( puint32 ) 

                return puint32+icol*pdvar->NRow+irow;
