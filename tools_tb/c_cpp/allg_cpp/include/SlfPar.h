...
namespace slf
{
  ...
  struct SParSearch2
  {
    ...
    SParSearch2(CParVarValCollect &ps) :parmeterset(ps){}
  };
  ...
  okay_t PrepareStructure(CStrV &inputvec, CStrV &textvec, CStr &texterr);
  ...
  protected:
    ...
    okay_t readParameters2(CStrV &inputvec, CStr &texterr);
