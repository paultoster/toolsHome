...
//========================================
#ifdef _DEBUG
    #ifndef NUMERIC_PROOF_FUNCTION
        #define NUMERIC_PROOF_FUNCTION
    #endif
#endif
#ifdef NDEBUG
    #ifdef NUMERIC_PROOF_FUNCTION
        #undef NUMERIC_PROOF_FUNCTION
    #endif
#endif
...
#define	NumericAllocate(n, type)	\
	((type *) NumericAllocateFunc(n, sizeof(type), "type"))
...
// Memory allocation, Do not call this function directly, use NumericAllocate(n, type)
...
typedef struct SNumericSpline3_tag {
...
SNumericSpline3 *NumericSpline3Coef(uint32_t n,double *xvec, double *yvec);
double         NumericSpline3(SNumericSpline3 *pZ,double x);
void           NumericSpline3Free(SNumericSpline3 *pZ);
#endif
//===================================================================
...
//
// SNumericSpline3 *pZ = NumericSpline3Coef(uint32_t n,double *xvec, double *yvec);
//
// Berechnung des spline
//
// double y = NumericSpline3(SNumericSpline3 *pZ,double x);
//
// Löschen der Koeffizienten
//
// viod NumericSpline3Free(SNumericSpline3 *pZ);
//
//===================================================================
typedef struct SNumericStep_tag {
...
//
// 
// SlfStepSet(SNumericStep *s,double xa,double xb,double ya,double yb)
// SlfStepCalc(SNumericStep *s,double x)
...
double FilterDigInit(SNumericFiltDig *ps, double xact);
...
typedef struct tag_SNumericFiltDig {
    uint8_t        na,nb;
    double       x[NUMERIC_MAX_FILT_ORDER+1];
    double       y[NUMERIC_MAX_FILT_ORDER+1];
    double       a[NUMERIC_MAX_FILT_ORDER+1];
    double       b[NUMERIC_MAX_FILT_ORDER+1];
}SNumericFiltDig;
